<template>
    <section class="parameter">
        ...
        <h2 class="total">
        	...
        	<el-button class='refresh' type="primary" :loading="false">刷新</el-button>共 <em class="em">1000</em> 条记录
        </h2>
                ...
                <el-table stripe class="this_table" :data="tableData3" border style="width: 100%">
                    <el-table-column label="操作" width="150">
                        <template scope="scope">
                            <el-button size="mini" :plain="true" @click="dialogFormVisible = true"  type="success" icon="edit"></el-button>
